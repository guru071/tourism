...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('budget_level', sa.String(50), nullable=True),
        sa.Column('day_plans', sa.JSON(), nullable=True),
        sa.Column('total_estimated_cost_usd', sa.Numeric(12, 2), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
